...
public class interface3 extends JFrame implements ActionListener {
	...
	interface3() {
	   ...
	   //建立哲学家对象
	   p[0]=new philoDemo3(0, pl[1], c[5], cl[5],
	     c[1], cl[1], cp[5],   cp[1], h[1], h[2],area);
	   p[1]=new philoDemo3(1, pl[2], c[1], cl[2],
	     c[2], cl[1], cp[2],   cp[1], h[4], h[3],area);
	   p[2]=new philoDemo3(2, pl[3], c[2], cl[2],
	     c[3], cl[3], cp[2],   cp[3], h[5], h[6],area);
	   p[3]=new philoDemo3(3, pl[4], c[3], cl[4],
	     c[4], cl[3], cp[4],   cp[3], h[8], h[7],area);
	   p[4]=new philoDemo3(4, pl[5], c[4], cl[4],
